...
function on_load_tiles() --load the tiles
   ...
   table.insert(tile_images,love.graphics.newImage("data/tiles/tile004.png") )
   ...
   table.insert(tile_images,love.graphics.newImage("data/tiles/tile008.png") )
   table.insert(tile_images,love.graphics.newImage("data/tiles/tile009.png") )
   ...
   table.insert(tile_images,love.graphics.newImage("data/walls/cube_wall003.png") )
   table.insert(tile_images,love.graphics.newImage("data/walls/cube_wall004.png") )
   table.insert(tile_images,love.graphics.newImage("data/walls/cube_wall005.png") )
   table.insert(tile_images,love.graphics.newImage("data/walls/cube_wall006.png") )
   table.insert(tile_images,love.graphics.newImage("data/walls/cube_wall007.png") )
